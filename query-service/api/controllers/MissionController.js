	...
	find: function(req, res, next) {
		...
		validateFindRequest(req)
			...
			.then(mongoQuery => {
				...
				return MissionService.performMongoQuery(mongoQuery);
			})
			.then(missions => MissionService.fillBoundingPolygonIntersectionTimes(_parsedQuery, missions))
